...
namespace TrackerUI
{
    public partial class TournamentViewerForm : Form
    {
        ...
        // Use int instead of string to avoid conversion
        ...
        private void Tournament_OnTournamentComplete(object sender, DateTime e)
        {
            ...
            // TODO Message box not displaying after tournament finish
            MessageBox.Show("Congratulations! You are the Champion!");
        ...
        {
            TournamantName.Text = tournament.TournamentName;
        }
        ...
        private string ValidateData()
        {
            ...
            {
                output = "We do not allow ties. Please play a rematch.";
            }
